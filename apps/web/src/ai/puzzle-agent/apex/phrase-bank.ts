...
export const PHRASE_BANK: readonly PhraseBankEntry[] = [
  ...
  },
  {
    ...
    notes: "eye + U + later",
    visualCues: [
      catalogCue("eye", "phonetic-anchor"),
      textCue("U", "phonetic-anchor"),
      catalogCue("clock", "semantic-anchor"),
    ],
  },
  {
    answer: "forgive",
  ...
  },
  {
    ...
    visualCues: [
      textCue("LET", "structural-anchor"),
      catalogCue("cat", "semantic-anchor"),
  ...
  // --- Expansion: math / typography / cultural / false-lead / compounds ---
  {
    answer: "two left feet",
    category: "math",
    difficultyHint: 6,
    techniqueAffinity: ["math_symbol_wordplay", "idiom_as_picture"],
    visualCues: [textCue("2"), textCue("LEFT"), catalogCue("footprints", "semantic-anchor")],
  },
  {
    answer: "six of one half dozen of the other",
    category: "math",
    difficultyHint: 8,
    techniqueAffinity: ["math_symbol_wordplay", "rare_but_fair_idiom"],
    visualCues: [textCue("6"), textCue("="), textCue("½ DOZEN")],
  },
  {
    answer: "zero hour",
    category: "math",
    difficultyHint: 5,
    techniqueAffinity: ["math_symbol_wordplay", "simple_compound"],
    visualCues: [textCue("0"), catalogCue("clock", "semantic-anchor")],
  },
  {
    answer: "plus one",
    category: "math",
    difficultyHint: 4,
    techniqueAffinity: ["math_symbol_wordplay"],
    visualCues: [operatorCue("+"), textCue("ONE")],
  },
  {
    answer: "little by little",
    category: "typography",
    difficultyHint: 6,
    techniqueAffinity: ["size_or_case_semantics", "positional_phrase"],
    visualCues: [textCue("LITTLE"), textCue("BY"), textCue("LITTLE")],
  },
  {
    answer: "mixed feelings",
    category: "typography",
    difficultyHint: 6,
    techniqueAffinity: ["size_or_case_semantics", "idiom_as_picture"],
    visualCues: [textCue("FeElInGs"), catalogCue("heart", "semantic-anchor")],
  },
  {
    answer: "small talk",
    category: "typography",
    difficultyHint: 5,
    techniqueAffinity: ["size_or_case_semantics", "simple_compound"],
    visualCues: [textCue("TALK")],
  },
  {
    answer: "capital idea",
    category: "typography",
  ...
  },
  {
    ...
    difficultyHint: 5,
    techniqueAffinity: ["size_or_case_semantics", "idiom_as_picture"],
    visualCues: [textCue("PRINT")],
  },
  {
    answer: "through the grapevine",
    category: "cultural",
    difficultyHint: 7,
    techniqueAffinity: ["cultural_common_knowledge_plus_twist", "spatial_preposition_play"],
    notes: "text THROUGH + leaf stand-in for grapevine",
    visualCues: [
      textCue("THROUGH", "structural-anchor"),
      catalogCue("leaf", "semantic-anchor"),
      textCue("VINE"),
    ],
  },
  {
  ...
  },
  {
    ...
    category: "cultural",
    difficultyHint: 5,
    techniqueAffinity: ["idiom_as_picture", "cultural_common_knowledge_plus_twist"],
    visualCues: [textCue("HIT"), catalogCue("wheat", "semantic-anchor")],
  },
  {
    ...
    difficultyHint: 6,
    techniqueAffinity: ["idiom_as_picture", "cultural_common_knowledge_plus_twist"],
    visualCues: [textCue("FACE"), catalogCue("music", "semantic-anchor")],
  },
  {
    answer: "star struck",
    category: "cultural",
    difficultyHint: 5,
    techniqueAffinity: ["simple_compound", "idiom_as_picture"],
    visualCues: [catalogCue("star"), textCue("STRUCK")],
  },
  {
    answer: "dog eat dog",
    category: "idiom",
    difficultyHint: 6,
    techniqueAffinity: ["false_lead_visual", "idiom_as_picture"],
    visualCues: [catalogCue("dog"), textCue("EAT"), catalogCue("dog")],
  },
  {
    ...
    difficultyHint: 7,
    techniqueAffinity: ["false_lead_visual", "idiom_as_picture"],
    visualCues: [catalogCue("cat"), textCue("TONGUE")],
  },
  {
    answer: "elephant in the room",
    category: "idiom",
    difficultyHint: 6,
    techniqueAffinity: ["false_lead_visual", "positional_phrase"],
    visualCues: [
      textCue("ELEPHANT"),
      textCue("IN", "structural-anchor"),
      catalogCue("house", "semantic-anchor"),
    ],
  },
  {
  ...
  },
  {
    ...
    category: "positional",
    difficultyHint: 5,
    techniqueAffinity: ["basic_positional", "positional_phrase"],
    visualCues: [textCue("HEAD"), textCue("HEELS")],
  },
  {
    answer: "mind over matter",
    category: "positional",
    difficultyHint: 6,
    techniqueAffinity: ["basic_positional", "positional_phrase"],
    visualCues: [catalogCue("brain", "semantic-anchor"), textCue("MATTER")],
  },
  {
  ...
  },
  {
    ...
    difficultyHint: 5,
    techniqueAffinity: ["simple_compound", "multi_emoji_compound"],
    visualCues: [textCue("CROSS"), catalogCue("map", "semantic-anchor")],
  },
  {
    answer: "doorbell",
    category: "compound",
    difficultyHint: 4,
    techniqueAffinity: ["simple_compound", "obvious_emoji_sum"],
    visualCues: [catalogCue("door"), catalogCue("bell")],
  },
  {
    answer: "firetruck",
    category: "compound",
    difficultyHint: 4,
    techniqueAffinity: ["simple_compound", "obvious_emoji_sum"],
    visualCues: [catalogCue("fire"), catalogCue("truck")],
  },
  {
    answer: "moonwalk",
    category: "compound",
    difficultyHint: 5,
    techniqueAffinity: ["simple_compound", "multi_emoji_compound"],
    visualCues: [catalogCue("moon"), catalogCue("footprints")],
  },
  {
    answer: "raincoat",
    category: "compound",
    difficultyHint: 4,
    techniqueAffinity: ["simple_compound", "obvious_emoji_sum"],
    visualCues: [catalogCue("umbrella", "semantic-anchor"), catalogCue("shirt")],
  },
  {
    answer: "trophy case",
    category: "compound",
    difficultyHint: 5,
    techniqueAffinity: ["simple_compound", "idiom_as_picture"],
    visualCues: [catalogCue("trophy"), textCue("CASE")],
  },
  {
    answer: "brainwash",
    category: "compound",
    difficultyHint: 6,
    techniqueAffinity: ["simple_compound", "false_lead_visual"],
    visualCues: [catalogCue("brain"), textCue("WATER")],
  },
  {
    answer: "earworm",
    category: "compound",
    difficultyHint: 6,
    techniqueAffinity: ["simple_compound", "nested_homophone"],
    visualCues: [catalogCue("ear"), catalogCue("bug", "semantic-anchor")],
  },
  {
    answer: "night owl",
    category: "compound",
    difficultyHint: 5,
    techniqueAffinity: ["simple_compound", "idiom_as_picture"],
    visualCues: [catalogCue("moon", "semantic-anchor"), catalogCue("bird", "semantic-anchor")],
  },
  {
    answer: "copycat",
    category: "compound",
    difficultyHint: 5,
    techniqueAffinity: ["simple_compound", "false_lead_visual"],
    visualCues: [catalogCue("newspaper", "semantic-anchor"), catalogCue("cat")],
  },
  {
    answer: "checkpoint",
    category: "compound",
    difficultyHint: 5,
    techniqueAffinity: ["math_symbol_wordplay", "simple_compound"],
    visualCues: [operatorCue("✓"), textCue("POINT")],
  },
  {
    answer: "countdown",
    category: "compound",
    difficultyHint: 5,
    techniqueAffinity: ["math_symbol_wordplay", "basic_positional"],
    visualCues: [textCue("3"), textCue("2"), textCue("1")],
  },
  {
  ...
  },
  {
    ...
    techniqueAffinity: ["multi_layer_phonetic", "idiom_as_picture"],
    visualCues: [
      catalogCue("hourglass", "semantic-anchor"),
      operatorCue("+"),
      catalogCue("eye", "phonetic-anchor"),
    ],
  },
