...
export const RESERVE_PUZZLES: readonly ReservePuzzle[] = [
  ...
  define({
    ...
    answer: "mailbox",
    parts: "Mail plus box",
    layers: [pictogram("envelope", "✉️"), plus(), pictogram("box", "📦")],
  }),
  define({
    id: "reserve:doorbell",
    answer: "doorbell",
  ...
  define({
    ...
    answer: "handbag",
    parts: "Hand plus bag",
    layers: [pictogram("hand", "✋"), plus(), pictogram("shopping-bag", "🛍️")],
  }),
  define({
    id: "reserve:bedtime",
    answer: "bedtime",
  ...
  define({
    ...
    layers: [pictogram("tent", "⛺"), plus(), pictogram("fire", "🔥")],
  }),
  define({
    id: "reserve:airmail",
    answer: "airmail",
  ...
  define({
    ...
    answer: "toolbox",
    parts: "Tool plus box",
    layers: [pictogram("wrench", "🔧"), plus(), pictogram("box", "📦")],
  }),
  define({
  ...
  define({
    ...
    layers: [pictogram("pizza", "🍕"), plus(), pictogram("box", "📦")],
  }),
  define({
    id: "reserve:eggplant",
    answer: "eggplant",
  ...
  define({
    ...
    layers: [pictogram("brain", "🧠"), plus(), pictogram("water", "💧")],
    category: "phrases_and_idioms",
    techniqueId: "idiom_as_picture",
  }),
  define({
  ...
  define({
    ...
    layers: [pictogram("puzzle", "🧩"), plus(), pictogram("cake", "🍰")],
    category: "phrases_and_idioms",
  ...
  define({
    ...
    layers: [pictogram("water", "💧"), pictogram("globe", "🌍")],
    category: "phrases_and_idioms",
    techniqueId: "spatial_preposition_play",
    layout: "stack",
    difficulty: 5,
