 ...
 */
export const TEXT_AREA_CONFIG: Record<DifficultyLevel, TextAreaDifficultyConfig> = {
  /**
 ...
 */
export function getTextAreaConfig(difficulty: number): TextAreaDifficultyConfig {
 ...
 */
export function getCharacterFeedbackConfig(difficulty: number): CharacterFeedbackConfig {
  ...
  return {
    ...
    showIncorrect: config.characterLevelFeedback && config.visualIntensity > 0.6,
