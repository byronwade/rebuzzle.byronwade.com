...
export const GLOBAL_CONTEXT: GlobalContext = {
  brandVoice: {
    ...
    style: "Professional yet approachable, with a focus on quality and user experience",
    personality: [
  ...
  qualityStandards: {
    ...
    scoringGuidelines: {
      exceptional: {
        min: 80,
        max: 100,
        description: "Rare, truly outstanding puzzles that are memorable and exceptional",
      },
      highQuality: {
        min: 70,
        max: 79,
      ...
      acceptable: {
        min: 60,
        max: 69,
        description: "Acceptable puzzles that are decent but may need minor improvements",
      },
      needsWork: {
        min: 50,
        max: 59,
  ...
  difficultyCalibration: {
    ...
    factors: [
      ...
      },
      {
        name: "cognitiveSteps",
        weight: 0.3,
        description: "How many mental leaps needed? (1 = single step, 10 = many complex steps)",
      },
      {
      ...
      },
      {
        ...
        weight: 0.15,
        description: "How advanced is the vocabulary? (1 = basic words, 10 = advanced vocabulary)",
      },
      {
        name: "patternNovelty",
        weight: 0.15,
...
export const DIFFICULTY_MIN = GLOBAL_CONTEXT.difficultyCalibration.minimumDifficulty ?? 4;
export const DIFFICULTY_MAX = GLOBAL_CONTEXT.difficultyCalibration.ranges?.impossible?.max ?? 8;
