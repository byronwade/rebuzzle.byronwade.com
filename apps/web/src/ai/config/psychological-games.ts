 ...
 */
export const PSYCHOLOGICAL_GAMES_CONFIG: Record<DifficultyLevel, PsychologicalGamesConfig> = {
  /**
 ...
 */
export function getPsychologicalGamesConfig(difficulty: number): PsychologicalGamesConfig {
