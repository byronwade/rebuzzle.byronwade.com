...
export const findSimilarPuzzlesTool = (tool as any)({
  ...
  parameters: z.object({
    ...
    limit: z.number().optional().default(5).describe("Maximum number of similar puzzles to return"),
    minSimilarity: z
      .number()
      .optional()
      .default(0.7)
...
export const getUserHistoryTool = (tool as any)({
  ...
  parameters: z.object({
    ...
    limit: z.number().optional().default(50).describe("Maximum number of attempts to return"),
  }),
...
export const getPuzzleStatisticsTool = (tool as any)({
  ...
  parameters: z.object({
    ...
    puzzleType: z.string().optional().describe("Filter by puzzle type (optional)"),
  }),
  execute: async ({ category, puzzleType }: { category?: string; puzzleType?: string }) => {
    try {
      ...
      for (const puzzle of puzzles) {
        ...
        // Type stats
        const type = puzzle.puzzleType || puzzle.metadata?.puzzleType || "rebus";
