...
interface GuessHistoryProps {
  /** Array of previous guess attempts */
  attempts: GuessAttempt[];
  /** The correct answer (for educational comparison) */
  correctAnswer?: string;
  /** Whether the history panel starts expanded */
...
/**
 * Collapsible panel showing previous guess attempts with word-by-word feedback
 */
          ...
          <div id="guess-history-content" className="border-t px-4 pb-4 pt-2 space-y-3">
            {attempts.map((attempt, index) => (
              <div key={index} className="rounded-lg border bg-muted/30 p-3 space-y-2">
                ...
                {/* Educational feedback for close guesses */}
            ...
            {/* Correct answer reveal (if provided and all attempts failed) */}
...
/**
 * Generate educational hint for close guesses
 */
