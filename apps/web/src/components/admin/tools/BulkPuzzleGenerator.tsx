...
export function BulkPuzzleGenerator({ onPuzzlesSaved }: BulkPuzzleGeneratorProps) {
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="difficulty-min">Min Difficulty: {formData.difficultyMin}/10</Label>
              <Slider
                className="mt-2"
                id="difficulty-min"
                max={10}
                min={5}
                onValueChange={([value]) => setFormData({ ...formData, difficultyMin: value ?? 5 })}
                step={1}
            ...
            <div>
              <Label htmlFor="difficulty-max">Max Difficulty: {formData.difficultyMax}/10</Label>
              <Slider
                className="mt-2"
                id="difficulty-max"
                max={10}
            ...
            >
              <div className="flex items-start gap-4 rounded-lg border p-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="line-clamp-2 text-muted-foreground text-sm">{puzzle.puzzle}</div>
                </div>
              </div>
            </div>
          );
