...
import { UserMenuShellLower } from "./user-menu-shell-lower";

export function UserMenuShell(props: Record<string, any>) {
  const {
    handleLogout,
    response,
    router
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          ...
          >
            ...
            <ChevronDown className="h-3.5 w-3.5 text-subtle transition-transform group-data-[state=open]:rotate-180" data-icon="inline-end" />
          </Button>
        </DropdownMenuTrigger>
  ...
  return (
    <DropdownMenu>      <UserMenuShellLower {...props} />
    </>
  );
}
