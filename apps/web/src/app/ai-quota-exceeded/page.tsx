        ...
        <div className="flex justify-center">
          <Card className="w-full max-w-2xl p-8 md:p-12">
            <div className="space-y-6 text-center">
              ...
              {/* Message */}
              <div>
                <h1 className="mb-3 font-bold text-3xl text-foreground">AI Quota Limit Reached</h1>
                <p className="mb-4 text-muted-foreground text-lg">
                  We've hit our daily limit for AI puzzle generation.
                </p>
                <p className="text-muted-foreground">
                  Don't worry! We have thousands of pre-generated puzzles ready for you. The AI
              ...
              <div className="border-border border-t pt-6">
                <p className="text-muted-foreground text-sm">
                  <strong className="text-foreground">Current Status:</strong> Using cached puzzles
                </p>
                <p className="mt-1 text-muted-foreground text-sm">
                  <strong className="text-foreground">Quota Resets:</strong> Daily at midnight PST
                </p>
              </div>
            </div>
          </Card>
