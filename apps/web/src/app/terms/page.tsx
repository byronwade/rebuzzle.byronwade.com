      ...
      <div className="mx-auto max-w-4xl px-4 py-3 md:px-6">
        ...
        <div className="mb-8">
          <div className="mb-2 flex items-center gap-3">
            ...
            <h1 className="font-semibold text-base md:text-lg">Terms of Service</h1>
          </div>
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none">
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">1. Acceptance of Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">2. Account Creation and Responsibilities</h2>
            <div className="space-y-4">
              <div>
                <h3 className="mb-2 font-medium text-base">Account Requirements</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div>
                <h3 className="mb-2 font-medium text-base">Account Eligibility</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">3. Acceptable Use Policy</h2>
            <p className="mb-4 text-muted-foreground text-sm leading-relaxed">You agree not to:</p>
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">4. Intellectual Property Rights</h2>
            <div className="space-y-4">
              <div>
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">6. User-Generated Content</h2>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">7. Account Termination</h2>
            <div className="space-y-4">
              <div>
                <h3 className="mb-2 font-medium text-base">Termination by You</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div>
                <h3 className="mb-2 font-medium text-base">Termination by Us</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div>
                <h3 className="mb-2 font-medium text-base">Effect of Termination</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">8. Limitation of Liability</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">10. Dispute Resolution</h2>
            <div className="space-y-4">
              <div>
          ...
          <section className="mb-8">
            <h2 className="mb-4 font-semibold text-xl">13. Contact Information</h2>
            <p className="text-muted-foreground text-sm leading-relaxed">
