...
> = {
  ...
  "logic-grid": {
    ...
    examples: ["Who lives where?", "What color is each house?", "Solve the relationships"],
  },
  "cryptic-crossword": {
    ...
    examples: ["Brave insect goes back and forth (4) = LION", "Part of tree in forest (4) = ROOT"],
  },
  "number-sequence": {
    name: "Number Sequence Puzzles",
    description: "Identify mathematical patterns and predict the next number(s) in a sequence.",
    keywords: [
      "number sequence",
      "pattern recognition",
      "math puzzle",
  ...
  "pattern-recognition": {
    ...
    description: "Visual pattern identification requiring observation and logical thinking.",
    keywords: [
      "pattern recognition",
      "visual pattern",
      "pattern puzzle",
  ...
  "caesar-cipher": {
    ...
    description: "Decode encrypted messages using Caesar cipher (letter shifting) techniques.",
    keywords: [
      "caesar cipher",
      "cipher puzzle",
      "code breaking",
  ...
  trivia: {
    ...
    examples: ["What is the capital of France?", "In what year did World War II end?"],
  },
};
      ...
      <div className="mx-auto max-w-4xl px-4 py-3 md:px-6">
        ...
        {typePosts.length > 0 ? (
          <div className="space-y-6">
            <h2 className="font-semibold text-base">Recent {puzzleInfo.name} Solutions</h2>
              ...
              {relatedTypes.slice(0, 6).map((relatedType) => {
                ...
                return (
                  <Link
                    ...
                    key={relatedType}
                  >
                    <h3 className="mb-1 font-medium text-sm">{relatedInfo.name}</h3>
