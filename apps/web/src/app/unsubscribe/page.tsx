        ...
        <div className="flex justify-center">
          <Card className="w-full max-w-md p-8">
            {status === "loading" && (
              <div className="text-center">
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-neutral-100 dark:bg-neutral-800">
                  <Mail className="h-8 w-8 text-neutral-700 dark:text-neutral-300" />
                </div>
                <h1 className="mb-2 font-semibold text-base md:text-lg">Unsubscribing...</h1>
            ...
            {status === "error" && (
              <div className="text-center">
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-neutral-100 dark:bg-neutral-800">
                  <XCircle className="h-8 w-8 text-neutral-700 dark:text-neutral-300" />
                </div>
                <h1 className="mb-2 font-semibold text-base md:text-lg">Unsubscribe Failed</h1>
                <p className="mb-6 text-muted-foreground text-sm">
            ...
            {status === "not-found" && (
              <div className="text-center">
                ...
                <h1 className="mb-2 font-semibold text-base md:text-lg">Invalid Link</h1>
                <p className="mb-6 text-muted-foreground text-sm">
