...
export function generateWebSiteSchema() {
  ...
  return {
    ...
    url: baseUrl,
    description:
      "Daily rebus puzzle game with AI-generated challenges - Free Wordle alternative",
...
export function generateGameSchema(puzzle: {
  ...
  return {
    ...
    gameItem: {
      ...
      description:
        puzzle.explanation ||
        `A ${puzzle.puzzleType || "rebus"} puzzle challenge`,
    },
    gameLocation: {
      "@type": "WebPage",
      url: getBaseUrl(),
...
export function generateSoftwareApplicationSchema() {
  ...
  return {
    ...
    softwareVersion: "1.0",
    releaseNotes:
      "Daily AI-generated puzzles with multiple types and difficulty levels",
    contentRating: {
      "@type": "Rating",
      ratingValue: "E",
