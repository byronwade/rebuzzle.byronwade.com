      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Review and edit the generated puzzle before saving
            </CardDescription>
          </div>
            ...
            {isEditing ? (
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-lg border bg-green-50 p-4 dark:bg-green-950/20">
                  ...
                  <div className="font-semibold text-green-800 text-lg dark:text-green-200">
                    {editedPuzzle.answer}
                  </div>
                </div>
                <div>
                ...
                {isEditing ? (
                  <Input
                    ...
                    onChange={(e) =>
                      setEditedPuzzle({
                        ...editedPuzzle,
                        difficulty: Number.parseInt(e.target.value) || 5,
                      })
                    }
                    type="number"
                ...
                <div>
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      value={
                        editedPuzzle.publishedAt
                          ? new Date(editedPuzzle.publishedAt)
                              .toISOString()
                              .slice(0, 16)
                          : ""
                      }
