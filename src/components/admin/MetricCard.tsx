    ...
    >
      <div className="p-5">
        <div className="mb-3 flex items-start justify-between">
          ...
          {icon && (
            <div className="rounded-lg bg-muted/50 p-2 text-muted-foreground/60">
              {icon}
            </div>
          )}
        </div>
          ...
          {trend && (
            <div
              className={cn(
                ...
                isPositive &&
                  "w-fit rounded-full bg-green-50 px-2 py-0.5 text-green-600 dark:bg-green-950/20 dark:text-green-400",
                isNegative &&
                  "w-fit rounded-full bg-red-50 px-2 py-0.5 text-red-600 dark:bg-red-950/20 dark:text-red-400",
