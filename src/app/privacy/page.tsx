        ...
        <div className="prose prose-sm dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Welcome to Rebuzzle. We are committed to protecting your privacy
              and ensuring transparency about how we collect, use, and protect
              your personal information. This Privacy Policy explains our
              practices regarding data collection, usage, and your rights.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  We use analytics services to understand how you interact with
                  our service:
                </p>
                <ul className="mt-2 ml-6 list-disc space-y-1 text-muted-foreground text-sm">
                  <li>
                    Vercel Analytics for web performance and user behavior
                  </li>
          ...
          <section className="mb-8">
            ...
            <ul className="ml-6 list-disc space-y-2 text-muted-foreground text-sm">
              ...
              <li>
                Send you email notifications about new puzzles and blog posts
                (with your consent)
              </li>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="ml-6 list-disc space-y-1 text-muted-foreground text-sm">
                ...
                <li>
                  Account-related communications (password resets, security
                  alerts)
                </li>
              </ul>
              <p className="text-muted-foreground text-sm leading-relaxed">
                <strong>Opt-in/Opt-out:</strong> New users are automatically
                subscribed to email notifications, but you can unsubscribe at
                any time by:
              </p>
              <ul className="ml-6 list-disc space-y-1 text-muted-foreground text-sm">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  We use Resend to send transactional and notification emails.
                  Resend processes your email address to deliver emails on our
                  behalf.
                </p>
              </div>
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Our application is hosted on Vercel, which provides hosting
                  and analytics services. Vercel Analytics collects anonymized
                  usage data.
                </p>
              </div>
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  We use MongoDB to store your account information, game
                  statistics, and analytics events. Data is stored securely and
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              or as needed to provide services. Analytics events are
              automatically deleted after one year. You can request deletion of
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              password hashing, and regular security assessments. However, no
