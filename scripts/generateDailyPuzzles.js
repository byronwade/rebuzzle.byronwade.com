...
const ANSWER_CATEGORIES = {
  compound_words: [
    ...
    },
    {
      ...
      hints: ["🌧️", "🎀"],
      difficulty: 2,
      explanation: "Rain (🌧️) + Bow (🎀) = Rainbow",
    },
    {
      answer: "moonlight",
      hints: ["🌙", "💡"],
    ...
    },
    {
      ...
      hints: ["❄️", "👤"],
      difficulty: 2,
      explanation: "Snow (❄️) + Man (👤) = Snowman",
    },
    {
      answer: "firefly",
      hints: ["🔥", "🦋"],
    ...
    },
    {
      ...
      hints: ["🏀", "⚽"],
      difficulty: 3,
      explanation: "Basket (🏀) + Ball (⚽) = Basketball",
    },
    {
      answer: "keyboard",
      hints: ["🔑", "📋"],
  ...
  phonetic_puzzles: [
    {
      ...
      hints: ["🌊", "weed"],
      difficulty: 3,
      explanation: "Sea (🌊) + Weed = Seaweed",
    },
    {
      answer: "because",
      hints: ["🐝", "cause"],
      difficulty: 3,
      explanation: 'Bee (🐝) sounds like "Be" + Cause = Because',
    },
    {
      answer: "believe",
      hints: ["🐝", "leaf", "🍃"],
      difficulty: 4,
      explanation: "Bee (🐝) + Leaf (🍃) + Eve = Believe",
    },
    {
      answer: "before",
      hints: ["🐝", "4️⃣"],
      difficulty: 3,
      explanation: "Bee (🐝) + Four (4️⃣) = Before",
    },
    {
      answer: "teacup",
      hints: ["🍵", "🏆"],
      difficulty: 2,
      explanation: "Tea (🍵) + Cup (🏆) = Teacup",
    },
    {
      answer: "iceberg",
      hints: ["🧊", "⛰️"],
      difficulty: 3,
      explanation: "Ice (🧊) + Berg (⛰️) = Iceberg",
    },
    {
      answer: "honeybee",
      hints: ["🍯", "🐝"],
  ...
  phrase_puzzles: [
    {
      ...
      hints: ["🧩", "of", "🍰"],
      difficulty: 4,
      explanation: "Piece (🧩) + of + Cake (🍰) = Piece of Cake (easy task)",
    },
    {
      answer: "break the ice",
      hints: ["💔", "the", "🧊"],
      difficulty: 4,
      explanation: "Break (💔) + the + Ice (🧊) = Break the Ice",
    },
    {
      answer: "time flies",
      hints: ["⏰", "🪰"],
      difficulty: 3,
      explanation: "Time (⏰) + Flies (🪰) = Time Flies",
    },
    {
      answer: "heart attack",
      hints: ["❤️", "attack"],
      difficulty: 4,
      explanation: "Heart (❤️) + Attack = Heart Attack",
    },
    {
      answer: "brain storm",
      hints: ["🧠", "⛈️"],
      difficulty: 3,
      explanation: "Brain (🧠) + Storm (⛈️) = Brainstorm",
    },
    {
      answer: "eye candy",
      hints: ["👁️", "🍭"],
      difficulty: 3,
      explanation: "Eye (👁️) + Candy (🍭) = Eye Candy",
    },
    {
      answer: "green thumb",
      hints: ["🟢", "👍"],
      difficulty: 4,
      explanation: "Green (🟢) + Thumb (👍) = Green Thumb",
    },
    {
      answer: "cold shoulder",
      hints: ["🥶", "🤷"],
      difficulty: 4,
      explanation: "Cold (🥶) + Shoulder (🤷) = Cold Shoulder",
    },
  ],
  ...
  creative_visual: [
    {
      ...
      hints: ["⬆️", "side", "⬇️"],
      difficulty: 3,
      explanation: "Up (⬆️) + Side + Down (⬇️) = Upside Down",
    },
    {
      answer: "inside out",
      hints: ["📦", "side", "📤"],
      difficulty: 3,
      explanation: "In (📦) + Side + Out (📤) = Inside Out",
    },
    {
      answer: "crossroads",
      hints: ["❌", "🛣️"],
      difficulty: 4,
      explanation: "Cross (❌) + Roads (🛣️) = Crossroads",
    },
    {
      answer: "waterfall",
      hints: ["💧", "fall"],
      difficulty: 3,
      explanation: "Water (💧) + Fall = Waterfall",
    },
    {
      answer: "earthquake",
      hints: ["🌍", "quake"],
      difficulty: 3,
      explanation: "Earth (🌍) + Quake = Earthquake",
    },
    {
      answer: "lighthouse",
      hints: ["💡", "🏠"],
      difficulty: 3,
      explanation: "Light (💡) + House (🏠) = Lighthouse",
    },
    {
      answer: "spaceship",
      hints: ["🌌", "🚢"],
      difficulty: 3,
      explanation: "Space (🌌) + Ship (🚢) = Spaceship",
    },
    {
      answer: "thunderbolt",
      hints: ["⚡", "🔩"],
      difficulty: 4,
      explanation: "Thunder (⚡) + Bolt (🔩) = Thunderbolt",
    },
  ],
  ...
  modern_tech: [
    ...
    },
    {
      ...
      hints: ["🟦", "🦷"],
      difficulty: 4,
      explanation: "Blue (🟦) + Tooth (🦷) = Bluetooth",
    },
    {
      answer: "facebook",
      hints: ["😀", "📖"],
      difficulty: 3,
      explanation: "Face (😀) + Book (📖) = Facebook",
    },
    {
      answer: "instagram",
      hints: ["📸", "gram"],
      difficulty: 4,
      explanation: "Instant (📸) + Gram = Instagram",
    },
    {
      answer: "youtube",
      hints: ["👤", "📺"],
      difficulty: 3,
      explanation: "You (👤) + Tube (📺) = YouTube",
    },
    {
      answer: "podcast",
      hints: ["🎧", "cast"],
      difficulty: 3,
      explanation: "Pod (🎧) + Cast = Podcast",
    },
    {
      answer: "website",
      hints: ["🕸️", "site"],
      difficulty: 3,
      explanation: "Web (🕸️) + Site = Website",
    },
    {
      answer: "download",
      hints: ["⬇️", "load"],
      difficulty: 2,
      explanation: "Down (⬇️) + Load = Download",
    },
  ],
  ...
  pop_culture: [
    {
      ...
      hints: ["💪", "👨"],
      difficulty: 2,
      explanation: "Super (💪) + Man (👨) = Superman",
    },
    {
      answer: "spiderman",
      hints: ["🕷️", "👨"],
      difficulty: 2,
      explanation: "Spider (🕷️) + Man (👨) = Spiderman",
    },
    {
      answer: "batman",
      hints: ["🦇", "👨"],
      difficulty: 2,
      explanation: "Bat (🦇) + Man (👨) = Batman",
    },
    {
      answer: "wonderwoman",
      hints: ["❓", "👩"],
      difficulty: 3,
      explanation: "Wonder (❓) + Woman (👩) = Wonder Woman",
    },
    {
      answer: "ironman",
      hints: ["⚙️", "👨"],
      difficulty: 2,
      explanation: "Iron (⚙️) + Man (👨) = Iron Man",
    },
    {
      answer: "starwars",
      hints: ["⭐", "⚔️"],
      difficulty: 3,
      explanation: "Star (⭐) + Wars (⚔️) = Star Wars",
    },
    {
      answer: "minecraft",
      hints: ["⛏️", "craft"],
      difficulty: 3,
      explanation: "Mine (⛏️) + Craft = Minecraft",
    },
    {
      answer: "netflix",
      hints: ["🌐", "flix"],
      difficulty: 4,
      explanation: "Net (🌐) + Flix = Netflix",
    },
  ],
};
...
function generatePuzzleForDate(date = new Date()) {
  ...
  return {
    ...
    hints: [
      `Think about ${metadata.topic.toLowerCase()}`,
      `This is a ${puzzle.difficulty <= 2 ? "beginner" : puzzle.difficulty <= 3 ? "intermediate" : "advanced"} level puzzle`,
      `The answer is ${puzzle.answer.split(/\s+/).length > 1 ? "a phrase" : "a single word"}`,
    ],
    ...metadata,
  };
}
